...
def main(spark):
    ...
    df_small.write.parquet('hdfs:/user/hl5679_nyu_edu/peopleSmall.parquet')
    df_moderate.write.parquet('hdfs:/user/hl5679_nyu_edu/peopleModerate.parquet')
    df_big.write.parquet('hdfs:/user/hl5679_nyu_edu/peopleBig.parquet')
