...
def main(spark, file_path):
    ...
    print(times)
    print(f'Maximum Time taken to run \'csv_brian\' Query 25 times on {file_path}:{max(times)}')
    print(f'minimum Time taken to run \'csv_brian\' Query 25 times on {file_path}:{min(times)}')
