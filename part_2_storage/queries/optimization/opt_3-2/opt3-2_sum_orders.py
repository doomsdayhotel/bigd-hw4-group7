...
def main(spark):
    ...
    df_moderate_repartitioned.write.mode('overwrite').parquet('hdfs:/user/qy561_nyu_edu/peopleModerateOpt3-2SumOrders.parquet')
    df_big_repartitioned.write.mode('overwrite').parquet('hdfs:/user/qy561_nyu_edu/peopleBigOpt3-2SumOrders.parquet')
