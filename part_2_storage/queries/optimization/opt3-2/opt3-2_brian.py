...
def main(spark):
    ...
    df_small_repartitioned.write.parquet('hdfs:/user/qy561_nyu_edu/peopleSmallOpt3-2Brian.parquet')
    df_moderate_repartitioned.write.parquet('hdfs:/user/qy561_nyu_edu/peopleModerateOpt3-2Brian.parquet')
    df_big_repartitioned.write.parquet('hdfs:/user/qy561_nyu_edu/peopleBigOpt3-2Brian.parquet')
