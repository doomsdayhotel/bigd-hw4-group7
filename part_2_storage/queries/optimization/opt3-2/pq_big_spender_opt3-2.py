...
if __name__ == "__main__":
    ...
    datasets = [
        'hdfs:/user/qy561_nyu_edu/peopleSmallOpt3-2BigSpender.parquet',
        'hdfs:/user/qy561_nyu_edu/peopleModerateOpt3-2BigSpender.parquet',
        'hdfs:/user/qy561_nyu_edu/peopleBigOpt3-2BigSpender.parquet'
    ]
