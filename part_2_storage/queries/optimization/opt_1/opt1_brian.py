...
def main(spark):
    ...
    df_small_sorted.write.parquet('hdfs:/user/qy561_nyu_edu/peopleSmallOpt1Brian.parquet')
    df_moderate_sorted.write.parquet('hdfs:/user/qy561_nyu_edu/peopleModerateOpt1Brian.parquet')
    df_big_sorted.write.parquet('hdfs:/user/qy561_nyu_edu/peopleBigOpt1Brian.parquet')
