...
def main(spark):
    ...
    df_small_sorted.write.parquet('hdfs:/user/qy561_nyu_edu/peopleSmallOpt1BigSpender.parquet')
    df_moderate_sorted.write.parquet('hdfs:/user/qy561_nyu_edu/peopleModerateOpt1BigSpender.parquet')
    df_big_sorted.write.parquet('hdfs:/user/qy561_nyu_edu/peopleBigOpt1BigSpender.parquet')
